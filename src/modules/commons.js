...
var EXPORTED_SYMBOLS =
  [ "icetray", "ICETRAY_VERSION", "ICETRAY_OS_SUPPORT", "ICETRAY_ID",
    "ICETRAY_PREF_BRANCH",
    "ICETRAY_APPLICATION_ICON_TYPE_THEMED",
    "ICETRAY_APPLICATION_ICON_TYPE_CUSTOM",
    "ICETRAY_MIDDLE_CLICK_ACTIVATE_LAST", "ICETRAY_MIDDLE_CLICK_SHOW_HIDE",
    "ICETRAY_NOTIFICATION_MESSAGE_COUNT",
    "ICETRAY_NOTIFICATION_NEWMAIL_ICON", "ICETRAY_NOTIFICATION_CUSTOM_ICON",
    "ICETRAY_IM_STATUS_AVAILABLE", "ICETRAY_IM_STATUS_AWAY",
    "ICETRAY_IM_STATUS_BUSY", "ICETRAY_IM_STATUS_OFFLINE",
    "ICETRAY_ACCOUNT_SERVER_TYPE_IM", "ICETRAY_DELAY_STARTUP_MILLISECONDS",
    "ICETRAY_DELAY_NOWAIT_MILLISECONDS", "ICETRAY_MESSAGE_COUNT_TYPE_UNREAD",
    "ICETRAY_MESSAGE_COUNT_TYPE_NEW", "ICETRAY_CHAT_ICON_BLINK_STYLE_NORMAL",
    "ICETRAY_CHAT_ICON_BLINK_STYLE_FADE", "ICETRAY_APPINDICATOR_ID",
    "ICETRAY_APP_DB", "ICETRAY_CB_SENTINEL" ];
...
const ICETRAY_VERSION     = "0.6.2"; // needed for sync call of onVersionChange() :(
const ICETRAY_OS_SUPPORT  = ['freebsd', 'linux', 'winnt']; // install.rdf sync :(
const ICETRAY_ID          = "{9533f794-00b4-4354-aa15-c2bbda6989f8}";
const ICETRAY_PREF_BRANCH = "extensions.icetray.";

const ICETRAY_APPLICATION_ICON_TYPE_THEMED = 0;
const ICETRAY_APPLICATION_ICON_TYPE_CUSTOM = 1;

const ICETRAY_MIDDLE_CLICK_ACTIVATE_LAST = 0;
const ICETRAY_MIDDLE_CLICK_SHOW_HIDE     = 1;

const ICETRAY_MESSAGE_COUNT_TYPE_UNREAD  = 0;
const ICETRAY_MESSAGE_COUNT_TYPE_NEW     = 1;

const ICETRAY_NOTIFICATION_MESSAGE_COUNT = 0;
const ICETRAY_NOTIFICATION_NEWMAIL_ICON  = 1;
const ICETRAY_NOTIFICATION_CUSTOM_ICON   = 2;

const ICETRAY_IM_STATUS_AVAILABLE = "user-available";
const ICETRAY_IM_STATUS_AWAY      = "user-away";
const ICETRAY_IM_STATUS_BUSY      = "user-busy";
const ICETRAY_IM_STATUS_OFFLINE   = "user-offline";

const ICETRAY_ACCOUNT_SERVER_TYPE_IM = "im";

const ICETRAY_DELAY_STARTUP_MILLISECONDS = 500;
const ICETRAY_DELAY_NOWAIT_MILLISECONDS  = 0;

const ICETRAY_CHAT_ICON_BLINK_STYLE_NORMAL = 0;
const ICETRAY_CHAT_ICON_BLINK_STYLE_FADE   = 1;

const ICETRAY_APPINDICATOR_ID = "icetray";

const ICETRAY_APP_DB = {
  ...
  icedoveuxp: {
    id:  "{3aa07e56-beb0-47a0-b0cb-c735edd25419}",
  },

  iceapeuxp: {
    id: "{9184b6fe-4a5c-484d-8b4b-efbfccbfb514}",
  },

  nightengale: {
    id: "nightengale@nightengalenest.com",
  },
...
let log = icetray.Logging.getLogger("icetray.commons");

icetray.Utils = {
  prefService: Services.prefs.getBranch(ICETRAY_PREF_BRANCH),
  strings: Services.strings.createBundle("chrome://icetray/locale/overlay.properties"),
  ...
  getObjPref: function(prefStr) {
    try {
      var objPref = JSON.parse(
        icetray.Utils.prefService.getCharPref(prefStr));
    } catch (x) {
      log.error(x);
    }
    return objPref;
  ...
  setObjPref: function(prefStr, obj) {
    log.debug(obj);
    try {
      icetray.Utils.prefService.setCharPref(prefStr, JSON.stringify(obj));
    } catch (x) {
      log.error(x);
    }
  },
